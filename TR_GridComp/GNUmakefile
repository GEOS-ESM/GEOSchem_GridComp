...
# 16jul2014  Manyin    Include new GravSetMod.
#
#-------------------------------------------------------------------------
...
SRCS = TR_GravSetMod DryDepositionGmiMod WetRemovalGmiMod TR_GridCompMod

MOD_DIRS = . $(INC_ESMF) $(INC_GMAO_SHARED) $(INC_CHEM_GMI)
...
# this used to depend on $(ACGS) too
