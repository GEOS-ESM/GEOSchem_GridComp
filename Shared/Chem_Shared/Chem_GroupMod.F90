...
! !INTERFACE:
 ...
 SUBROUTINE Set_GCC_Globals()
  ...
  chem_group_names(1) = 'SPC_Bry'
  chem_group_names(2) = 'SPC_Cly'

  iBR         = 1   ; gcc_group_species(iBR)     = 'SPC_Br    '
  iBR2        = 2   ; gcc_group_species(iBR2)    = 'SPC_Br2   '
  iBRCL       = 3   ; gcc_group_species(iBRCL)   = 'SPC_BrCl  '
  iBRNO2      = 4   ; gcc_group_species(iBRNO2)  = 'SPC_BrNO2 '
  iBRNO3      = 5   ; gcc_group_species(iBRNO3)  = 'SPC_BrNO3 '
  iBRO        = 6   ; gcc_group_species(iBRO)    = 'SPC_BrO   '
  iHBR        = 7   ; gcc_group_species(iHBR)    = 'SPC_HBr   '
  iHOBR       = 8   ; gcc_group_species(iHOBR)   = 'SPC_HOBr  '

  iCL         = 9   ; gcc_group_species(iCL)     = 'SPC_Cl    '
  iCL2        = 10  ; gcc_group_species(iCL2)    = 'SPC_Cl2   '
  iCL2O2      = 11  ; gcc_group_species(iCL2O2)  = 'SPC_Cl2O2 '
  iCLNO2      = 12  ; gcc_group_species(iCLNO2)  = 'SPC_ClNO2 '
  iCLNO3      = 13  ; gcc_group_species(iCLNO3)  = 'SPC_ClNO3 '
  iCLO        = 14  ; gcc_group_species(iCLO)    = 'SPC_ClO   '
  iCLOO       = 15  ; gcc_group_species(iCLOO)   = 'SPC_ClOO  '
  iHCL        = 16  ; gcc_group_species(iHCL)    = 'SPC_HCl   '
  iHOCL       = 17  ; gcc_group_species(iHOCL)   = 'SPC_HOCl  '
  iOCLO       = 18  ; gcc_group_species(iOCLO)   = 'SPC_OClO  '

  iN2O5       = 19  ; gcc_group_species(iN2O5)   = 'SPC_N2O5  '
  iNO         = 20  ; gcc_group_species(iNO)     = 'SPC_NO    '
  iNO2        = 21  ; gcc_group_species(iNO2)    = 'SPC_NO2   '
  iHNO3       = 22  ; gcc_group_species(iHNO3)   = 'SPC_HNO3  ' 
