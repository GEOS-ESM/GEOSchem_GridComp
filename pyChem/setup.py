...
"""pyChem is the NDSL version of GEOS Chem."""
...
setup(
    ...
    description=("pyChem is the NDSL version of NASA GMAO's GEOS Chem."),
    install_requires=[],
    ...
    name="pyChem",
    packages=find_namespace_packages(include=["pyChem", "pyChem.*"]),
    setup_requires=[],
    test_suite="tests",
