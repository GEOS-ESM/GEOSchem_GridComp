...
!....           NO2 + O = NO + O2
!
      rcarr(51,:) = skarr(  5.100D-12 ,-210.0D+00 ,temperature)
!
!....           NO3 + O = NO2 + O2
!
      rcarr(52,:) = skarr(  1.000D-11 ,0.0D+00 ,temperature)
!
!....           NO2 + OH = HNO3
!
...
!....           HNO3 + OH = H2O + NO3
!
      rcarr(54,:) = skohhno3 (temperature ,adcol)
!
!....           NO + OH = HNO2
!
      rcarr(55,:) = sktroe(  7.000D-31 ,2.60D0 & 
     &                     , 3.600D-11 ,0.10D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           HNO2 + OH = H2O + NO2
!
      rcarr(56,:) = skarr(  1.800D-11 ,390.0D+00 ,temperature)
!
!....           HO2 + NO2 = HNO4
!
...
!....           HNO4 + OH = H2O + NO2 + O2
!
      rcarr(59,:) = skarr(  1.300D-12 ,-380.0D+00 ,temperature)
!
!....           HO2 + NO3 = NO2 + O2 + OH
!
...
!....           NO + NO3 = 2 NO2
!
      rcarr(61,:) = skarr(  1.500D-11 ,-170.0D+00 ,temperature)
!
!....           NO3 + OH = HO2 + NO2
!
      rcarr(62,:) = skarr(  2.200D-11 ,0.0D+00 ,temperature)
!
!....           NO2 + NO3 = N2O5
!
...
!....           NO2 + NO3 = NO + NO2 + O2
!
      rcarr(67,:) = skarr(  4.500D-14 ,1260.0D+00 ,temperature)
!
...
!....           CHBr3 + OH = 3 Br
!
      rcarr(102,:) = skarr(  1.400D-12 ,600.0D+00 ,temperature)
!
!....           CH2Br2 + OH = 2 Br
!
...
!....           HFC125 + OH = H2O
!
      rcarr(122,:) = skarr(  6.000D-13 ,1700.0D+00 ,temperature)
!
!....           HFC134a + OH = H2O
!
...
!
      rcarr(128,:) = skarr(  2.900D-12 ,-350.0D+00 ,temperature)
!
!....           ACET + OH = ATO2 + H2O
!
...
!....           ALK4 + OH = R4O2
!
      rcarr(134,:) = skarr(  9.100D-12 ,405.0D+00 ,temperature)
!
!....           ATO2 + HO2 = MCO3 + MO2
!
...
!....           ATO2 + MCO3 = ACTA + MEK
!
      rcarr(136,:) = skarr(  1.870D-13 ,-500.0D+00 ,temperature)
!
!....           ATO2 + MCO3 =  0.20 CH2O +  0.80 HO2 +  0.20 MCO3 +  0.80 MGLY + MO2
!
      rcarr(137,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(139,:) = skarr(  2.800D-12 ,-300.0D+00 ,temperature)
!
!....           B3O2 + HO2 = RB3P
!
...
!
      rcarr(144,:) = skarr(  2.700D-12 ,-350.0D+00 ,temperature)
!
!....           C2H6 + NO3 = ETO2 + HNO3
!
...
!....           C3H8 + OH = A3O2
!
      rcarr(148,:) = skc3h8ox_2 (temperature)
!
!....           C3H8 + OH = B3O2
!
      rcarr(149,:) = skc3h8ox_1 (temperature)
!
!....           EOH + OH = ALD2 + HO2
!
...
!
      rcarr(151,:) = skarr(  4.100D-14 ,0.0D+00 ,temperature)
!
!....           ETO2 + ETO2 = ALD2 + EOH
!
      rcarr(152,:) = skarr(  2.700D-14 ,0.0D+00 ,temperature)
!
!....           ETO2 + NO = ALD2 + HO2 + NO2
!
      rcarr(153,:) = skarr(  2.600D-12 ,-365.0D+00 ,temperature)
!
...
!
      rcarr(155,:) = skarr(  8.000D-12 ,0.0D+00 ,temperature)
!
!....           GLYC + OH = CO + HCOOH + OH
!
      rcarr(156,:) = skarr(  8.000D-12 ,0.0D+00 ,temperature)
!
...
!....           GLYX + OH = 2 CO + HO2
!
      rcarr(158,:) = skohglyx (temperature ,oxygen)
!
!....           HAC + OH = HO2 + MGLY
!
      rcarr(159,:) = skarr(  2.150D-12 ,-305.0D+00 ,temperature)
!
!....           HAC + OH =  0.50 ACTA +  0.50 CO +  0.50 HCOOH +  0.50 MO2 + OH
!
      rcarr(160,:) = skarr(  2.150D-12 ,-305.0D+00 ,temperature)
!
!....           ETO2 + HO2 = ETP
!
      rcarr(161,:) = skarr(  2.910D-13 ,-1300.0D+00 ,temperature)
!
!....           HO2 + MCO3 = ACTA + O3
!
...
!
      rcarr(165,:) = skarr(  3.700D-11 ,0.0D+00 ,temperature)
!
!....           HO2 + IAO2 = IAP
!
      rcarr(166,:) = skarr(  2.910D-13 ,-1300.0D+00 ,temperature)
!
!....           IAO2 + MCO3 = ACTA + MEK
!
...
!....           HO2 + INO2 = INPN
!
      rcarr(172,:) = skino2_ho2 (temperature)
!
!....           INO2 + MCO3 =  0.15 CH2O +  0.85 HNO3 +  0.80 HO2 +  0.10 MACR + MO2 +  0.05 MVK +  0.15 NO2
!
      rcarr(173,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(175,:) = skarr(  1.300D-12 ,0.0D+00 ,temperature)
!
...
!....           INPN + OH = INO2
!
      rcarr(177,:) = skarr(  5.180D-12 ,-200.0D+00 ,temperature)
!
!....           HO2 + ISN1 = ISNP
!
...
!....           ISOP + NO3 = INO2
!
      rcarr(183,:) = skarr(  3.300D-12 ,450.0D+00 ,temperature)
!
!....           ISOP + O3 =  0.90 CH2O +  0.05 CO +  0.06 HO2 +  0.39 MACR +  0.16 MVK +  0.10 O3 +  0.27 OH +  0.07 PRPE
!
      rcarr(184,:) = skarr(  1.000D-14 ,1970.0D+00 ,temperature)
!
!....           ISOP + OH = RIO2
!
      rcarr(185,:) = skarr(  3.100D-11 ,-350.0D+00 ,temperature)
!
!....           HO2 + KO2 = MGLY + MO2
!
...
!
      rcarr(193,:) = skarr(  1.400D-15 ,2100.0D+00 ,temperature)
!
!....           MACR + OH =  0.53 MAO3 +  0.47 MRO2
!
      rcarr(194,:) = skarr(  8.000D-12 ,-380.0D+00 ,temperature)
!
!....           HO2 + MAN2 = ISNP
!
...
!
      rcarr(200,:) = skarr(  4.300D-13 ,-1040.0D+00 ,temperature)
!
!....           MAO3 + MCO3 = CH2O + MCO3 + MO2
!
      rcarr(201,:) = skarr(  2.500D-12 ,-500.0D+00 ,temperature)
!
!....           MAO3 + MO2 = 2 CH2O + HO2 + MCO3
!
      rcarr(202,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
!....           MAO3 + MO2 = CH2O + RCOOH
!
...
!....           MAO3 + NO2 = PMN
!
      rcarr(204,:) = sktroe(  9.000D-28 ,8.90D0 & 
     &                     , 7.700D-12 ,0.20D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           MAO3 + NO =  0.50 CH2O +  0.50 CO +  0.50 MCO3 +  0.50 MO2 + NO2
!
      rcarr(205,:) = skarr(  6.700D-12 ,-340.0D+00 ,temperature)
!
!....           MAOP + OH = MAO3
!
      rcarr(206,:) = skarr(  3.600D-12 ,-380.0D+00 ,temperature)
!
!....           A3O2 + MCO3 = ACTA + RCHO
!
...
!
      rcarr(208,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
!....           ETO2 + MCO3 = ACTA + ALD2
!
...
!
      rcarr(210,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
!....           MCO3 + MCO3 = 2 MO2
!
      rcarr(211,:) = skarr(  2.500D-12 ,-500.0D+00 ,temperature)
!
!....           MCO3 + MO2 = ACTA + CH2O
!
...
!
      rcarr(213,:) = skarr(  1.800D-12 ,-500.0D+00 ,temperature)
!
!....           MCO3 + NO2 = PAN
!
      rcarr(214,:) = sktroe(  9.700D-29 ,5.60D0 & 
...
!
      rcarr(217,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
!....           MEK + NO3 = HNO3 + KO2
!
...
!....           MGLY + OH = CO + MCO3
!
      rcarr(221,:) = skarr(  1.500D-11 ,0.0D+00 ,temperature)
!
...
!....           MVK + OH = VRO2
!
      rcarr(231,:) = skarr(  2.600D-12 ,-610.0D+00 ,temperature)
!
!....           MAP + OH =  0.50 CH2O +  0.50 MCO3 +  0.50 OH
!
      rcarr(232,:) = skarr(  6.130D-13 ,-200.0D+00 ,temperature)
!
!....           OH + RCHO = H2O + RCO3
!
...
!....           PMN = MAO3 + NO2
!
      rcarr(236,:) = skppndecomp (temperature,adcol)
!
...
!
      rcarr(245,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(250,:) = skarr(  5.500D-15 ,1880.0D+00 ,temperature)
!
!....           OH + PRPE = PO2
!
      rcarr(251,:) = sktroe(  8.000D-27 ,3.50D0 & 
...
!
      rcarr(254,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
!....           MCO3 + R4N1 = ACTA + NO2 + RCHO
!
      rcarr(255,:) = skarr(  1.870D-13 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(261,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(263,:) = skro2noabs_1 (temperature ,adcol)
!
!....           NO + R4O2 = R4N2
!
      rcarr(264,:) = skro2noadd_1 (temperature ,adcol)
!
...
!
      rcarr(271,:) = skarr(  1.680D-12 ,-500.0D+00 ,temperature)
!
!....           MO2 + RCO3 = CH2O + RCOOH
!
      rcarr(272,:) = skarr(  1.870D-13 ,-500.0D+00 ,temperature)
!
!....           NO2 + RCO3 = PPN
!
...
!....           NO + RIO1 = HNO3
!
      rcarr(279,:) = skro2noadd_2 (temperature ,adcol)
!
...
!....           OH + ROH = HO2 + RCHO
!
      rcarr(288,:) = skarr(  4.600D-12 ,-70.0D+00 ,temperature)
!
...
!....           NO3 + NO3 = 2 NO2 + O2
!
      rcarr(322,:) = skarr(  8.500D-13 ,2450.0D+00 ,temperature)
!
!....           HO2 =  0.50 H2O
!
      rcarr(323,:) = sktrs_ho2 (temperature, & 
     &            sadcol2, adcol, radA, NSADaer, NSADdust, cPBLcol, pressure)
!
!....           NO2 =  0.50 HNO2 +  0.50 HNO3
!
      rcarr(324,:) = sktrs_no2 (temperature, & 
     &            sadcol2, adcol, radA, NSADaer,NSADdust,ptrop, pressure)
!
!....           NO3 = HNO3
!
      rcarr(325,:) = sktrs_no3 (temperature, & 
     &            sadcol2, adcol, radA,NSADaer,NSADdust,ptrop, pressure)
!
!....           N2O5 = 2 HNO3
!
...
!....           DMS + NO3 = HNO3 + SO2
!
      rcarr(328,:) = skarr(  1.900D-13 ,-530.0D+00 ,temperature)
!
!....           O + SO2 = H2SO4
!
      rcarr(329,:) = sktroe(  1.800D-33 ,-2.00D0 & 
     &                     , 4.200D-14 ,-1.80D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           OH + SO2 = H2SO4
!
      rcarr(330,:) = sktroe(  3.300D-31 ,4.30D0 & 
     &                     , 1.600D-12 ,0.00D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           O3 + SO2 = H2SO4
!
      rcarr(331,:) = skarr(  3.000D-12 ,7000.0D+00 ,temperature)
!
!....           O + OCSg = CO + SO2
!
      rcarr(332,:) = skarr(  2.100D-11 ,2200.0D+00 ,temperature)
!
!....           OCSg + OH = SO2
!
      rcarr(333,:) = skarr(  7.200D-14 ,1070.0D+00 ,temperature)
!
...
!
          fsubc = 0.6d0
          af = 5.9d-33      !.... JPL 15-10
          npwr = 1.0        !.... JPL 15-10
          ai = 1.1d-12      !.... JPL 15-10
          mpwr = -1.3       !.... JPL 15-10
!
! 2)
          ae = 0.0D0
          skcooh(:) = skcooh(:) + sktroe(af,npwr,ai,mpwr,ae,tk(:),ad(:))
!
        END FUNCTION skcooh
!
!.... skohch4 (temperature)
