...
! Aggregate function
  ...
  Vdot(31) = A(2)+A(3)+A(5)+A(30)+A(32)+2*A(37)+A(38)+A(40)+A(64)+1.4*A(65)+1.04*A(66)+1.04*A(68)+0.06*A(70)+0.04*A(72)&
               ...
               &*A(285)+A(288)+A(290)+2*A(297)+A(298)+0.67*A(299)+0.60*A(300)+0.56*A(303)+0.19*A(306)+A(319)+A(320)+A(321)&
  ...
  Vdot(50) = -A(479)
  Vdot(51) = A(261)-A(662)
  Vdot(52) = -0.79*A(302)-A(678)
  Vdot(53) = -0.90*A(307)-A(679)
  Vdot(54) = -0.86*A(308)-A(680)
  Vdot(55) = -0.90*A(314)-A(681)
  Vdot(56) = -0.90*A(315)-A(682)
  Vdot(57) = -0.86*A(316)-A(683)
  Vdot(58) = -0.65*A(309)-A(689)
  ...
  Vdot(73) = -A(263)-0.70*A(305)-A(663)
  ...
  Vdot(85) = -0.65*A(312)-A(334)-A(686)
  Vdot(86) = A(381)-A(382)-2*A(383)-A(580)-A(581)-A(584)-A(697)
  Vdot(87) = -0.75*A(306)-A(332)-A(687)
  ...
  Vdot(143) = A(269)+A(274)+A(277)+A(278)-A(289)-A(290)-A(291)-A(292)-A(293)+0.22*A(299)+0.20*A(300)+A(339)+A(610)
  ...
  Vdot(210) = A(243)-A(244)-2*A(247)-2*A(248)-A(249)+A(252)-A(254)+A(255)-A(262)-A(297)+0.20*A(300)+0.44*A(303)+0.95&
                &*A(304)+0.70*A(305)+0.31*A(309)+0.45*A(310)+0.75*A(317)-A(356)-A(357)-A(358)-A(388)-A(389)-A(390)-A(658)&
                &+A(661)
  ...
  Vdot(222) = -A(243)-A(245)+A(246)+2*A(247)+A(249)-A(250)+A(251)+A(253)+A(254)-A(255)-A(256)-A(257)-A(258)-A(259)&
                &-A(260)-A(261)+3*A(263)+2*A(264)+A(265)+A(297)+0.60*A(300)+0.56*A(303)+0.95*A(304)+1.40*A(305)+0.34*A(309)&
  ...
  Vdot(225) = -0.88*A(299)+A(321)-A(324)+A(336)+A(337)+A(339)+A(340)+A(341)+2*A(361)+A(362)+A(363)+A(364)+A(366)+A(367)&
  ...
  Vdot(226) = -A(266)-A(267)-A(268)-A(269)-A(270)-A(271)-A(272)-A(273)-A(274)-A(280)-A(281)-A(299)-A(300)-A(301)-A(302)&
                ...
                &+A(605)+A(713)
  Vdot(227) = 0.66*A(299)+0.75*A(301)+2.37*A(302)+0.19*A(306)+1.80*A(307)+0.86*A(308)+0.31*A(309)+0.69*A(311)+0.79&
                &*A(313)+1.8*A(314)+0.75*A(315)+A(318)+A(320)+A(324)+A(328)+2*A(329)+3*A(330)+3*A(331)+A(332)+2*A(333)&
                ...
                &+A(676)+3*A(677)+4*A(678)+3*A(679)+2*A(680)+3*A(681)+2*A(682)+A(683)+2*A(684)+2*A(685)+1*A(686)+1*A(687)&
  ...
  Vdot(228) = A(6)-A(252)-A(253)+A(267)+A(268)-A(275)-A(276)-A(278)-A(279)+2*A(281)-A(282)-A(284)-A(285)-A(286)-A(287)&
                &-A(288)+A(292)+A(294)+A(295)+A(296)-A(297)-A(298)+0.12*A(299)+0.2*A(300)+0.25*A(301)+0.21*A(302)+0.05&
                &*A(304)+0.30*A(305)+0.25*A(306)+0.10*A(307)+0.14*A(308)+0.35*A(309)+0.55*A(310)+0.31*A(311)+0.35*A(312)&
                &+0.21*A(313)+0.10*A(314)+0.10*A(315)+0.14*A(316)+0.25*A(317)-A(343)-A(359)+A(604)+2*A(606)+A(607)+A(616)&
  ...
  Vdot(232) = A(2)-A(3)+A(5)-A(8)+A(9)-A(10)-2*A(11)+A(12)+A(14)-A(15)+2*A(17)+A(22)-A(27)+A(28)-A(30)+A(32)+A(35)+A(36)&
                ...
                &+A(722)
  Vdot(233) = 0.22*A(299)+0.75*A(301)+0.79*A(302)+0.56*A(306)+0.90*A(307)+0.86*A(308)+0.34*A(309)+0.69*A(311)+0.65&
                &*A(312)+0.79*A(313)+0.90*A(314)+0.90*A(315)+0.86*A(316)-A(319)-A(320)-A(321)+A(325)+A(338)+A(342)-A(343)&
  ...
  Vdot(234) = -A(2)+A(3)-2*A(6)-2*A(7)-A(8)-A(9)+A(10)-A(12)-A(13)-A(18)-A(20)-A(22)-A(23)-A(24)-A(25)-A(26)-A(29)+A(30)&
                ...
                &-A(263)-A(264)-A(265)+2*A(266)+A(269)+A(272)-A(277)-A(278)+A(279)-A(283)+A(288)+A(290)+2*A(291)+A(298)+0.66&
                &*A(299)+0.60*A(300)-A(318)-A(320)-A(321)-A(322)-A(323)-A(324)-A(325)-A(326)-A(327)-A(328)-A(329)-A(330)&
