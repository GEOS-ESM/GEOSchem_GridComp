...
! End INLINED RCONST
  ...
  RCONST(270) = (GCARR(4.64E-11,0.0E+00,20.0))
  RCONST(271) = (GCARR(7.26E-11,0.0E+00,20.0))
  ...
  RCONST(308) = (GCARR(1.40E-10,0.0E+00,25.0))
  ...
  RCONST(319) = (GCARR(1.80E-12,0.0E+00,-600.0))
  ...
  RCONST(353) = (GCJPLPR(8.80E-06,3.6E+00,-8537.0,1.71E+15,1.6E0,-8537.0,0.6,0.0,0.0))
  ...
  RCONST(361) = (GCARR(2.03E-11,0.0E+00,-1110.0))
