...
contains
    subroutine SetServices(gc, rc)
        ...
        ! add children
        quickchem = MAPL_AddChild(gc, name='QuickChem', ss=QuickChem_SetServices, __RC__)

        ! declare imports and exports based on StateSpecs.rc tables
#include "QAerosol_Internal___.h"
#include "QAerosol_Export___.h"
#include "QAerosol_Import___.h"
...
#include "QAerosol_DeclarePointer___.h"
...
#include "QAerosol_GetPointer___.h"
...
end module QAerosol_GridComp_mod
